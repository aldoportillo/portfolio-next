...
| [Docker](https://code.visualstudio.com/docs/containers/overview) | Build, manage, and deploy containerized applications. |
| [WakaTime](https://marketplace.visualstudio.com/items?itemName=WakaTime.vscode-wakatime) | Track the time you spent coding |
| [Indent Rainbow](https://marketplace.visualstudio.com/items?itemName=oderwat.indent-rainbow) | Make indentation easier to read |
| [Blockman](https://marketplace.visualstudio.com/items?itemName=leodevbro.blockman) | Mark and highlight code blocks |
